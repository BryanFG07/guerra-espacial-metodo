...
function oprimir_btn(i) {
  if (posibles_respuestas[i] == pregunta.respuesta) {
    ...
    Swal.fire({
      ...
      text:'La nave enemiga lo ha capturado y no pudo ganar su libertad, tu puntuación es: 260',
...
function TiempoPreguntas(){
  ...
  if(tiempop==0){
    document.getElementById('tiempop').style.display="none";
        Swal.fire({
            title: 'Perdiste',
            text:'El tiempo se ha agotado, tu puntuación es: 260',
            icon:'error',
...
var tiempo=50;
var puntos=0;
var puntosnecesario=40;
var ene=document.getElementById('enemigo1');
ene.style.width='200px';
ene.style.height='200px';
ene.style.borderRadius='100%';
ene.style.transition='all 0.1s';
var Nivel=10;
var puntostotales=0;
var ene2=document.getElementById('enemigo2');
ene2.style.width='150px';
ene2.style.height='150px';
ene2.style.transformStyle='0.2s';
var ene3=document.getElementById('enemigo3');
ene3.style.width='120px';
ene3.style.height='120px';
ene3.style.transition='all 0.2s';
...
setInterval(Mover2,700);
setInterval(Mover3,700);
...
function Pregunta(){
  ...
  document.getElementById('tiempo').style.display="none";
    Swal.fire({
        ...
        if (result.value) {
            window.location = "/preguntas10.html";
        }
    });
}
function siguiente(){
    ...
    Swal.fire({
        title: 'FELICIDADES',
        text:'HA ESCAPADO DE LAS NAVES ENEMIGAS, SU PUNTUACIÓN ES: '+puntostotales,
        icon:'success',
        confirmButtonText:'Volver al inicio',
        background:'#40724C',
        allowOutsideClick:false,
