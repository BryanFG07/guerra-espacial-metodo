...
function oprimir_btn(i) {
  if (posibles_respuestas[i] == pregunta.respuesta) {
    ...
    Swal.fire({
      ...
      text:'La nave enemiga lo ha capturado y no pudo ganar su libertad, tu puntuación es: 116',
...
function TiempoPreguntas(){
  ...
  if(tiempop==0){
    document.getElementById('tiempop').style.display="none";
        Swal.fire({
            title: 'Perdiste',
            text:'El tiempo se ha agotado, tu puntuación es: 116',
            icon:'error',
...
function Pregunta(){
  ...
  document.getElementById('tiempo').style.display="none";
    Swal.fire({
        ...
        if (result.value) {
            window.location = "/preguntas6.html";
        }
    });
}
function siguiente(){
