...
function oprimir_btn(i) {
  if (posibles_respuestas[i] == pregunta.respuesta) {
    ...
    Swal.fire({
      ...
      text:'La nave enemiga lo ha capturado y no pudo ganar su libertad su puntuación es: 0',
...
function TiempoPreguntas(){
  ...
  if(tiempop==0){
    document.getElementById('tiempop').style.display="none";
        Swal.fire({
            title: 'Perdiste',
            text:'El tiempo se ha agotado, su puntuación es: 0',
            icon:'error',
