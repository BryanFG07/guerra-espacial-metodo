...
function oprimir_btn(i) {
  if (posibles_respuestas[i] == pregunta.respuesta) {
    ...
    Swal.fire({
      ...
      text:'La nave enemiga lo ha capturado y no pudo ganar su libertad, tu puntuación es: 87',
...
function TiempoPreguntas(){
  ...
  if(tiempop==0){
    document.getElementById('tiempop').style.display="none";
        Swal.fire({
            title: 'Perdiste',
            text:'El tiempo se ha agotado, tu puntuación es: 87',
            icon:'error',
...
ene2.style.width='80px';
ene2.style.height='80px';
...
function Pregunta(){
  ...
  document.getElementById('tiempo').style.display="none";
    Swal.fire({
        ...
        if (result.value) {
            window.location = "/preguntas5.html";
        }
    });
}
function siguiente(){
